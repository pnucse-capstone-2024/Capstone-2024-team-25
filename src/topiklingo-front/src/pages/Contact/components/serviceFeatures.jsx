    ...
    <section className="relative">
      ...
      <div className="relative max-w-screen mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          {/* Section header */}
          <div className="max-w-screen mx-auto text-center pb-12 md:pb-16">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            {/* Content */}
            <div className="max-w-screen md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6">
            ...
            {/* Tabs items */}
            <div className="max-w-screen md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1">
