export default function ServiceFeaturesBlocks() {
    return (
      <section className="relative">
        ...
        <div className="relative max-w-screen mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-20">
            ...
            {/* Section header */}
            <div className="max-w-screen mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4">Explore the solutions</h2>
              <p className="text-xl text-gray-600">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat.</p>
            </div>
  
            {/* Items */}
            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-full lg:max-w-none">
