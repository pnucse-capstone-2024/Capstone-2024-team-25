...
def generate_reading_2_problem_type_10(verbose=False, default_model="gpt-4o-mini"):
    total_cost = 0
    ...
    problem_generate_model.request_models_responses(
        [
            SystemMessage(
                content="#너는 문제를 출제하는 선생님이야. 예시처럼 주어지는 주제에 대한 글의 올바른 내용 고르기 문제 1개를 생성해줘. 정답은 1개로 명확한 선택지를 구성해야해. 단, 예문은 4~5문장으로 구성해줘. #답변 예시 "
                + example_prompt
            ),
